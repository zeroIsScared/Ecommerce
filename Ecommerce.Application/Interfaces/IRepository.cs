 ...
 public interface IRepository<T> where T: class
    {
        ...
        Task RemoveRangeAsync(IEnumerable<T> removeList, CancellationToken cancellationToken = default);
        Task SoftRemoveAsync(long id, CancellationToken cancellationToken = default);
        Task SoftRemoveRangeAsync(IEnumerable<T> removeList, CancellationToken cancellationToken = default);
